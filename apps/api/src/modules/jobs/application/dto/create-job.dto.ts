...
export class CreateJobDto {
  @ApiProperty({ example: 'Senior Backend Engineer', minLength: 3, maxLength: 200 })
  @IsString()
  @MinLength(3)
  @MaxLength(200)
  title!: string;

  @ApiProperty({ minLength: 10, maxLength: 20000 })
  @IsString()
  @MinLength(10)
  @MaxLength(20000)
  description!: string;
...
// companyId is intentionally not part of the DTO body — a company can only ever create
// jobs for itself, so the handler derives it from the authenticated employer's own company.
